...
OutputBaseFilename=SCIRunWithMeshingTools_4.0
AllowNoIcons=yes
Compression=lzma
...
; SCIRun build
Source: "bin\Release_Mesh\Release\*.exe"; DestDir: "{app}\bin"; Flags: ignoreversion replacesameversion
Source: "bin\Release_Mesh\Release\*.bat"; DestDir: "{app}\bin"; Flags: ignoreversion replacesameversion
Source: "bin\Release_Mesh\lib\Release\*.dll"; DestDir: "{app}\bin"; Flags: ignoreversion replacesameversion
