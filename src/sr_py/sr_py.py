...
class ShowTextureVolumeAlg(_object):
    ...
    def get_p_cmap_size(*args): return _sr_py.ShowTextureVolumeAlg_get_p_cmap_size(*args)
    ...
    def set_p_cmap_size(*args): return _sr_py.ShowTextureVolumeAlg_set_p_cmap_size(*args)
