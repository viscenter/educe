itcl_class SCIRun_ChangeFieldData_ApplyFilterToFieldData {
    ...
    method ui {} {
        ...
        iwidgets::tabnotebook $w.frame.filters -height 200 -tabpos n        
 ...
 #       $w.frame.filters add -label "Gaussian Blur" -command "set $this-method gaussblur"
  ...
  #      set gaussianblur [$w.frame.filters childsite 1]
        ...
        radiobutton $erodedilate.f.erode -text "Erode" -variable $this-ed-method -value "erode"
        radiobutton $erodedilate.f.dilate -text "Dilate" -variable $this-ed-method -value "dilate"
        radiobutton $erodedilate.f.dilateerode -text "Dilate -> Erode" -variable $this-ed-method -value "dilateerode"
        label $erodedilate.f.niterationslabel -text "number of iterations"
        entry $erodedilate.f.niterations -textvariable $this-ed-iterations
